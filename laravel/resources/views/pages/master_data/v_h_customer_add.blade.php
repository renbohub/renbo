        ...
        <div class="col-12">
            <div class="ibox ">
                ...
                <div class="ibox-content">
                        ...
                        <form method="POST" action="{{route('master.customer.create.action')}}"> 
                            @csrf
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <div>
                                        <label> <input type="radio" value="personal" id="optionsRadios1" name="customer_type" required>
                                            Personal
                                        </label>
                                    </div>
                                    <div>
                                        <label> <input type="radio" value="company" id="optionsRadios2" name="customer_type" required> 
                                            Company
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div class="form-group  row">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="customer_address" rows="10" class="form-control"></textarea>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group  row">
                            ...
                            <div class="form-group  row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" value="" name="customer_website">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group  row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" value="" name="customer_number">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
