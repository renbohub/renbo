                ...
                <div class="card-body py-5" style="overflow: scroll">
                    ...
                    <div class="px-5">
                        <table class="table my-0" id="header-2">
                            <thead>
                                <tr>
                                    <td rowspan="13" style="font-size: 16px">
                                ...
                                <tr >
                                    <td class="py-2  bg-light">{{$quotation_head->so_date}}</td>
                                </tr>
                                <tr>
                                    <td>SO Number</td>
                                </tr>
                                <tr >
                                    <td class="py-2  bg-light">{{$quotation_head->so_number}}</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td><input  id="no-po" onchange="updateNoPO()" type="text" class="form-control" value="{{$quotation_head->cust_po_number}}" name="title-head" placeholder="input tittle..."></td>
                                </tr>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 border">
                                <div class="row">
                                    <div class="col-3 border text-center @if ($quotation_head->quotation_status == 0) bg-warning @endif">
                                        Drafted
                                    </div>
                                    <div class="col-3 border text-center @if ($quotation_head->quotation_status == 1) bg-info @endif">
                                        Wait Approval
                                    </div>
                                    <div class="col-3 border text-center @if ($quotation_head->quotation_status == 2) bg-info @endif">
                                        Approved
                                    </div>
                                    <div class="col-3 border text-center @if ($quotation_head->quotation_status >= 3) bg-info @endif">
                                        Quoatation Send
                                    </div>
...
function addFunction(index){
    ...
    var desc= $("input[name='quotation_desc[]']").map(function() { return $(this).val();}).get();
...
function updateNoPO(){
    var dropdown = document.getElementById("no-po");
    var selectedValue = dropdown.value;
    var q_id = '{{$quotation_head->quotation_id}}';
    $.ajax({
                url: '{{route("so.edit.ponumber")}}',
                type: 'POST',
                data: {
                    '_token': '{{ csrf_token() }}',
                    'value' : selectedValue,
